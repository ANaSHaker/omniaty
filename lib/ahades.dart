...
class AhadesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("احاديث الرسول",style: TextStyle(fontWeight: FontWeight.bold,fontStyle: FontStyle.italic),),
        centerTitle: true,
        elevation: 10,
      ),
      body: Ahades(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            Hades(widget.pageHades1,widget.pageHades1 == "" ?Colors.transparent:  Theme.of(context).brightness == Brightness.dark ? Colors.grey[700]: Color(0xffD4AF37)),
            Hades(widget.pageHades2,widget.pageHades2 == "" ?Colors.transparent:   Theme.of(context).brightness == Brightness.dark ? Colors.grey[700]: Color(0xffD4AF37)),
             Hades(widget.pageHades3,widget.pageHades3 == "" ?Colors.transparent:  Theme.of(context).brightness == Brightness.dark ? Colors.grey[700]: Color(0xffD4AF37)),
            Hades(widget.pageHades4,widget.pageHades4 == "" ?Colors.transparent:  Theme.of(context).brightness == Brightness.dark ? Colors.grey[700]: Color(0xffD4AF37)),
          ],
